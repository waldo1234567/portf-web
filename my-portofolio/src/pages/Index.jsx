            ...
            <div className={darkMode ? "dark" : ""}>
                ...
                <div className={`${darkMode ? "dark: transition duration-300 ease-in-out delay-150 bg-black" : "bg-slate-50"} max-w-full`} ref={skillsRef}>
                    ...
                    <div className="custom-shape-divider-bottom-1713816615">
                        <svg width="100%" height="100%" id="svg" viewBox="0 0 1440 590" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150"><defs>
                            <linearGradient id="gradient" x1="10%" y1="21%" x2="90%" y2="79%"><stop offset="5%" stop-color="#0693e3"></stop><stop offset="95%" stop-color="#0693e3"></stop></linearGradient>
                        </defs><path d="M 0,600 L 0,300 C 90.14285714285714,286.7678571428571 180.28571428571428,273.5357142857143 310,249 C 439.7142857142857,224.46428571428572 608.9999999999999,188.625 736,181 C 863.0000000000001,173.375 947.7142857142858,193.96428571428572 1058,181 C 1168.2857142857142,168.03571428571428 1304.142857142857,121.51785714285714 1440,75 L 1440,600 L 0,600 Z" stroke="none" stroke-width="0" fill="url(#gradient)" fill-opacity="0.53" class="transition-all duration-300 ease-in-out delay-150 path-0"></path>
                            <defs><linearGradient id="gradient" x1="10%" y1="21%" x2="90%" y2="79%"><stop offset="5%" stop-color="#0693e3"></stop><stop offset="95%" stop-color="#0693e3"></stop></linearGradient></defs><path d="M 0,600 L 0,500 C 124.46428571428572,507.9821428571429 248.92857142857144,515.9642857142858 353,490 C 457.07142857142856,464.0357142857143 540.7500000000001,404.12500000000006 653,373 C 765.2499999999999,341.87499999999994 906.0714285714284,339.5357142857143 1042,328 C 1177.9285714285716,316.4642857142857 1308.9642857142858,295.7321428571429 1440,275 L 1440,600 L 0,600 Z" stroke="none" stroke-width="0" fill="url(#gradient)" fill-opacity="1" class="transition-all duration-300 ease-in-out delay-150 path-1"></path></svg>
                    </div>
                    ...
                    </style><defs><linearGradient id="gradient" x1="10%" y1="21%" x2="90%" y2="79%"><stop offset="5%" stop-color="#8ed1fc"></stop><stop offset="95%" stop-color="#0693e3"></stop></linearGradient></defs><path d="M 0,600 L 0,300 C 71.51196172248802,322.71770334928226 143.02392344497605,345.4354066985646 254,311 C 364.97607655502395,276.5645933014354 515.4162679425838,184.97607655502392 628,167 C 740.5837320574162,149.02392344497608 815.3110047846889,204.66028708133973 905,213 C 994.6889952153111,221.33971291866027 1099.3397129186603,182.38277511961724 1191,139 C 1282.6602870813397,95.61722488038278 1361.3301435406697,47.80861244019139 1440,0 L 1440,600 L 0,600 Z" stroke="none" stroke-width="0" fill="url(#gradient)" fill-opacity="0.53" class="transition-all duration-300 ease-in-out delay-150 path-0" transform="rotate(-180 720 300)"></path><style>
                        </style><defs><linearGradient id="gradient" x1="10%" y1="21%" x2="90%" y2="79%"><stop offset="5%" stop-color="#8ed1fc"></stop><stop offset="95%" stop-color="#0693e3"></stop></linearGradient></defs><path d="M 0,600 L 0,500 C 65.15789473684211,470.9090909090909 130.31578947368422,441.8181818181818 236,446 C 341.6842105263158,450.1818181818182 487.8947368421052,487.6363636363637 605,460 C 722.1052631578948,432.3636363636363 810.1052631578948,339.6363636363636 887,291 C 963.8947368421052,242.36363636363637 1029.6842105263158,237.8181818181818 1120,230 C 1210.3157894736842,222.1818181818182 1325.157894736842,211.0909090909091 1440,200 L 1440,600 L 0,600 Z" stroke="none" stroke-width="0" fill="url(#gradient)" fill-opacity="1" class="transition-all duration-300 ease-in-out delay-150 path-1" transform="rotate(-180 720 300)"></path></svg>
